...
class CourseAdmin(admin.ModelAdmin):
    ...
    list_display = ('course_title', 'course_active','course_start_time', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday', 'course_private',)
    list_filter = ('course_title', 'course_start_time', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday', 'course_active', 'course_private',)
...
class CourseScheduleAdmin(admin.ModelAdmin):
    ...
    list_display = ('course', 'schedule_date', 'schedule_start_time',)
